...
<p align="center">
  <img src="docs/screenshots/capture-form.png" alt="スマホ撮影フォーム（1画面完結：撮影・年代/座標ミニマップ・ジャンル・大学内外）" width="360">
</p>

スマホ最適化の撮影フォーム。撮影・年代選択・座標ミニマップ（中心の緯度経度をリアルタイム反映）・ジャンル・大学内/外を1画面で完結します。

### 管理レビュー画面（カンバン）

<p align="center">
  <img src="docs/screenshots/admin-review.png" alt="管理レビュー画面（カンバン・ダミーデータ）" width="900">
</p>

撮影済み → レビュー待ち → 公開済み の3レーンで OCR 結果を高速レビュー・承認します。OCR原文とレビュー後本文を並べて確認でき、楽観的ロック（version）で複数レビュワーの同時編集にも安全に対応。

> 掲載画像はプライバシー配慮のため**ダミーデータ**です（実際の来場者データは含みません）。
